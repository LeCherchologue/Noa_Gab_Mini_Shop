...
class GenAsdecodeCrudApi extends Command
{
    ...
    public function handle()
    {
        ...
        //generer les observers
        $observer = fopen(base_path('app/Observers/' . $arguments['name'] . 'Observer.php'), "w");
        fwrite($observer, "<?php" . PHP_EOL);
        fwrite($observer, PHP_EOL);
        fwrite($observer, "namespace App\Observers;" . PHP_EOL);
        fwrite($observer, PHP_EOL);
        fwrite($observer, "use App\Models\\" . $arguments['name'] . ";" . PHP_EOL);
        fwrite($observer, "use App\Observers\BaseObserver;" . PHP_EOL);
        fwrite($observer, PHP_EOL);
        fwrite($observer, "class " . $arguments['name'] . "Observer extends BaseObserver" . PHP_EOL);
        fwrite($observer, "{" . PHP_EOL);
        fwrite($observer, "    public function created(" . $arguments['name'] . " $" . $model_snake . "): void" . PHP_EOL);
        fwrite($observer, "    {" . PHP_EOL);
        fwrite($observer, "        if (isset(auth('sanctum')->user()->id)) {" . PHP_EOL);
        fwrite($observer, "            $" . "activite = [" . PHP_EOL);
        fwrite($observer, "                'libelle' => 'ajouté " . $model_snake . " ID'.$" . $model_snake . "->id," . PHP_EOL);
        fwrite($observer, "                'description' => 'Création de " . $model_snake . " ID'.$" . $model_snake . "->id.' par l\'utilisateur '.auth('sanctum')->user()->name. ' le '.$" . $model_snake . "->created_at->format('d/m/Y H:i')," . PHP_EOL);
        fwrite($observer, "                'ligne' => $" . $model_snake . "->id," . PHP_EOL);
        fwrite($observer, "                'table' => '" . $model_snake . "s'," . PHP_EOL);
        fwrite($observer, "                'details' => $" . $model_snake . "," . PHP_EOL);
        fwrite($observer, "                'api_route' => '" . $model_snake . ".show'," . PHP_EOL);
        fwrite($observer, "            ];" . PHP_EOL);
        fwrite($observer, "            $" . "this->storeActivity($" . "activite);" . PHP_EOL);
        fwrite($observer, "        }" . PHP_EOL);
        fwrite($observer, "    }" . PHP_EOL);
        fwrite($observer, PHP_EOL);
        fwrite($observer, "    public function updated(" . $arguments['name'] . " $" . $model_snake . "): void" . PHP_EOL);
        fwrite($observer, "    {" . PHP_EOL);
        fwrite($observer, "        if (isset(auth('sanctum')->user()->id)) {" . PHP_EOL);
        fwrite($observer, "            $" . "activite = [" . PHP_EOL);
        fwrite($observer, "                'libelle' => 'modifié " . $model_snake . " ID'.$" . $model_snake . "->id," . PHP_EOL);
        fwrite($observer, "                'description' => 'Modification de " . $model_snake . " ID'.$" . $model_snake . "->id.' par l\'utilisateur '.auth('sanctum')->user()->name. ' le '.$" . $model_snake . "->created_at->format('d/m/Y H:i')," . PHP_EOL);
        fwrite($observer, "                'ligne' => $" . $model_snake . "->id," . PHP_EOL);
        fwrite($observer, "                'table' => '" . $model_snake . "s'," . PHP_EOL);
        fwrite($observer, "                'details' => [" . PHP_EOL);
        fwrite($observer, "                    'before' => $" . $model_snake . "->getOriginal()," . PHP_EOL);
        fwrite($observer, "                    'after' => $" . $model_snake . "," . PHP_EOL);
        fwrite($observer, "                ]," . PHP_EOL);
        fwrite($observer, "                'api_route' => '" . $model_snake . ".show'," . PHP_EOL);
        fwrite($observer, "            ];" . PHP_EOL);
        fwrite($observer, "            $" . "this->storeActivity($" . "activite);" . PHP_EOL);
        ...
        fwrite($observer, "    }" . PHP_EOL);
        fwrite($observer, PHP_EOL);
        fwrite($observer, "    public function deleted(" . $arguments['name'] . " $" . $model_snake . "): void" . PHP_EOL);
        fwrite($observer, "    {" . PHP_EOL);
        fwrite($observer, "        if (isset(auth('sanctum')->user()->id)) {" . PHP_EOL);
        fwrite($observer, "            $" . "activite = [" . PHP_EOL);
        fwrite($observer, "                'libelle' => 'supprimé " . $model_snake . " ID'.$" . $model_snake . "->id," . PHP_EOL);
        fwrite($observer, "                'description' => 'Suppression de " . $model_snake . " ID'.$" . $model_snake . "->id.' par l\'utilisateur '.auth('sanctum')->user()->name. ' le '.$" . $model_snake . "->created_at->format('d/m/Y H:i')," . PHP_EOL);
        fwrite($observer, "                'ligne' => $" . $model_snake . "->id," . PHP_EOL);
        fwrite($observer, "                'table' => '" . $model_snake . "s'," . PHP_EOL);
        fwrite($observer, "                'details' => $" . $model_snake . "," . PHP_EOL);
        fwrite($observer, "                'api_route' => '" . $model_snake . ".show'," . PHP_EOL);
        ...
        fwrite($observer, "    }" . PHP_EOL);
        fwrite($observer, PHP_EOL);
        fwrite($observer, "    public function restored(" . $arguments['name'] . " $" . $model_snake . "): void" . PHP_EOL);
        fwrite($observer, "    {" . PHP_EOL);
        fwrite($observer, "        if (isset(auth('sanctum')->user()->id)) {" . PHP_EOL);
        fwrite($observer, "            $" . "activite = [" . PHP_EOL);
        fwrite($observer, "                'libelle' => 'restoré " . $model_snake . " ID'.$" . $model_snake . "->id," . PHP_EOL);
        fwrite($observer, "                'description' => 'Restoration de " . $model_snake . " ID'.$" . $model_snake . "->id.' par l\'utilisateur '.auth('sanctum')->user()->name. ' le '.$" . $model_snake . "->created_at->format('d/m/Y H:i')," . PHP_EOL);
        fwrite($observer, "                'ligne' => $" . $model_snake . "->id," . PHP_EOL);
        fwrite($observer, "                'table' => '" . $model_snake . "s'," . PHP_EOL);
        fwrite($observer, "                'details' => $" . $model_snake . "," . PHP_EOL);
        fwrite($observer, "                'api_route' => '" . $model_snake . ".show'," . PHP_EOL);
        ...
        fwrite($observer, "    }" . PHP_EOL);
        fwrite($observer, PHP_EOL);
        fwrite($observer, "    public function forceDeleted(" . $arguments['name'] . " $" . $model_snake . "): void" . PHP_EOL);
        fwrite($observer, "    {" . PHP_EOL);
        fwrite($observer, "        if (isset(auth('sanctum')->user()->id)) {" . PHP_EOL);
        fwrite($observer, "            $" . "activite = [" . PHP_EOL);
        fwrite($observer, "                'libelle' => 'supprimé définitivement " . $model_snake . " ID'.$" . $model_snake . "->id," . PHP_EOL);
        fwrite($observer, "                'description' => 'Suppression définitive de " . $model_snake . " ID'.$" . $model_snake . "->id.' par l\'utilisateur '.auth('sanctum')->user()->name. ' le '.$" . $model_snake . "->created_at->format('d/m/Y H:i')," . PHP_EOL);
        fwrite($observer, "                'ligne' => $" . $model_snake . "->id," . PHP_EOL);
        fwrite($observer, "                'table' => '" . $model_snake . "s'," . PHP_EOL);
        fwrite($observer, "                'details' => $" . $model_snake . "," . PHP_EOL);
        fwrite($observer, "                'api_route' => '" . $model_snake . ".show'," . PHP_EOL);
